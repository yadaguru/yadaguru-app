...
DROP TABLE IF EXISTS base_reminders CASCADE;
DROP TABLE IF EXISTS timeframes CASCADE;
DROP TABLE IF EXISTS base_reminders_timeframes CASCADE;
...
CREATE TABLE IF NOT EXISTS base_reminders_timeframes (
  id                SERIAL  PRIMARY KEY                     NOT NULL,
  timeframe_id      INT     REFERENCES timeframes (id)      NOT NULL,
  base_reminder_id  INT     REFERENCES base_reminders (id)  NOT NULL
);

CREATE TABLE IF NOT EXISTS reminders (
  id            SERIAL  PRIMARY KEY              NOT NULL,
  school_id     INT     REFERENCES schools (id)  NULL,
...
insert into categories (id, name) values(1, 'Absolute Deadline');
insert into categories (id, name) values(2, 'Application');
insert into categories (id, name) values(3, 'Essay Writing');
insert into categories (id, name) values(4, 'Financial Aid');
insert into categories (id, name) values(5, 'General Reminder');
insert into categories (id, name) values(6, 'Portfolio Prep');
insert into categories (id, name) values(7, 'Recommendations');
insert into categories (id, name) values(8, 'Testing Registration');

INSERT INTO tests (id, type, message, detail) VALUES
  (1, 'ACT', '<p>Go to <a href=\"http://actstudent.org\" target=\"\">actstudent.org </a>to register for your ACT test  Remember to include the schools you are applying to as a recipient of your test scores.</p>','If you''re planning on taking the ACT Test on %TESTDATE%, you must register by %REGDATE%.'),
  (2, 'SAT', '<p>Go to the College Board site and register to take the SAT.  Go to <a href=\"https://sat.collegeboard.org/register\" target=\"\">https://sat.collegeboard.org/register</a>.  Remember to include the schools you are applying to as a recipient of your test scores.</p>', 'If you''re planning on taking the SAT Test on %TESTDATE%, you must register by %REGDATE%');

INSERT INTO test_dates (admin_date, registration_date, test_id) VALUES 
('2015-09-12', '2015-08-07', 1),
('2015-10-03', '2015-09-03', 2),
('2015-10-24', '2015-09-18', 1),
('2015-11-07', '2015-10-09', 2),
('2015-12-05', '2015-11-05', 2),
('2015-12-12', '2015-11-06', 1),
('2016-01-23', '2015-12-28', 2),
('2016-02-06', '2016-01-08', 1),
('2016-03-05', '2015-02-05', 2),
('2016-04-09', '2016-03-04', 1),
('2016-05-07', '2015-04-08', 2),
('2016-06-04', '2015-05-05', 2),
('2016-06-11', '2016-05-06', 1);

INSERT INTO base_reminders (id, name, message, category_id, detail) VALUES
  ...
  (7,
   ...
   'Start writing your essays right away!',
    3,
   'Essays are usually the hardest and most time-consuming part of the application so you should get started as soon as possible.  Read and re-read what''s required for %SCHOOL% and start to think about how you will answer the essays. Be careful to note the number of essays required!'),
  ...
  (18,
   ...
   'Check your progress on your required and optional essays.',
    3,
   '<p>It''s only a month until %SCHOOL%''s deadline!</p><p>If you haven''t be sure to write an essay draft and get some feedback from a teacher or other objective adult who can offer some constructive criticism.&nbsp;</p><p>Check out our <a href=''http//yadaguru.com/#/faqs'' target=''''>FAQs</a> for links on essay writing.</p>'),

  (19,
   'Remind Recommenders',
   'Check in with your teachers by %DATE% about the status of %SCHOOL% recommendations.',
    7,
  ...
  (20,
   'Call the school',
   'CALL %SCHOOL% to make sure they''ve received everything!',
    5,
  ...
  (21,
   'Request Transcripts',
   'Have you requested your transcripts be sent to %SCHOOL% yet?',
    2,
   '<p>It''s only 21 days until your application for %SCHOOL% is due!<br><br>Make sure you know the process get any proper paperwork and follow the directions of your high school regarding transcript release. They''ll probably need a mailing address for the %SCHOOL% admissions office too so go prepared!<br><br><i>NOTE<b> </b>If this university uses <a href=''https//www.commonapp.org/'' target=''''>Common App</a> or <a href=''https//www.universalcollegeapp.com/'' target=''''>Universal Application</a> make sure you invited your guidance counselor to upload your transcripts and his/her recommendation for you.</i></p>'),
  ...
  (24,
   'Request Transcripts',
   'If you haven''t request your transcripts be sent to %SCHOOL%.',
    2,
   '<p>It''s only 14 days until your application for %SCHOOL% is due! Have you asked the guidance office to send your transcripts? Make this a priority this week if you haven''t yet.&nbsp;<br><br><i>NOTE If %SCHOOL% uses <a href=''https//www.commonapp.org/'' target=''''>Common App</a> or <a href=''https//www.universalcollegeapp.com/'' target=''''>Universal Application</a> make sure you invited your guidance counselor to upload your transcripts and his/her recommendation for you.</i></p>'),

  (25,
   'VISUAL ARTS MAJORS Submit your Portfolio',
   'VISUAL ARTS MAJORS Time to submit that portfolio to %SCHOOL%',
    1,
   '<p>After the paint glue sweat and tears have dried it''s time to submit that portfolio!&nbsp;</p><p>Make sure it''s been uploaded correctly and that you actually pressed the submit button.</p><p><i>NOTE %SCHOOL% may want you to submit your portfolio through another application like <a href=''http//www.slideroom.com'' target=''''>slideroom.com</a>. &nbsp;Make sure you visit %SCHOOL%''s website and know HOW to submit that portfolio. In some cases you may need to create a user in something like slideroom in order to submit.&nbsp;See our <a href=''http//yadaguru.com/#/faqs'' target=''''>FAQs </a>for more information.&nbsp;</i><br></p>'),

  (26,
   'Submit Online Essays',
   'Are you submitting any essays online; email or upload?',
    3,
   '<p>It''s exactly a week until %SCHOOL%''s application deadline.You''ve been working hard on your essays but are they ready?&nbsp;</p><div><br>'),
  ...
  (29,
   ...
   'Check-in with your recommenders about any online recommendations for %SCHOOL%.',
    7,
  ...
  (31,
   ...
   '%SCHOOL%''s application is due %DATE%.',
    1,
   '<p>This is the date that %SCHOOL% should have every part of your application; from essays to recommendations to SAT scores. Some schools require that all pieces are in others will accept them weeks after. <br><br>Check with the university if you fear you might not get a piece in on time. Some colleges are more lenient&nbsp;but <b>don''t assume.</b><br></p>'),

  (32,
   'NCDD',
   'National College Decision Day',
    5,
   '<p>May 1 is National College Decision Day. If you get accepted to multiple colleges including %SCHOOL% you''ll need to decide in s wouldlwhich school you will enroll.&nbsp;Usually you must pay an enrollment or housing deposit to secure your space.&nbsp;</p><p>Consider -- Which school is your best fit academically and socially? Which school grants you the most affordable financial aid package?&nbsp;</p><p>Remember It is best to send a deposit to only ONE school. It''s generally considered unethical to send in deposits to multiple schools...not to mention awfully costly to you! Carefully consider your options and make the best choice for you. Ask for help from a knowledgable adult if you''re not sure.</p>');

insert into timeframes (id, name, formula) values(1, 'January 1', 'jan1');
insert into timeframes (id, name, formula) values(2, 'May 1', 'may1');
insert into timeframes (id, name, formula) values(3, 'Immediately', 'now');
insert into timeframes (id, name, formula) values(4, 'Due Date', '0');
insert into timeframes (id, name, formula) values(5, '7 Days', '7');
insert into timeframes (id, name, formula) values(6, '12 Days', '12');
insert into timeframes (id, name, formula) values(7, '14 Days', '14');
insert into timeframes (id, name, formula) values(8, '21 Days', '21');
insert into timeframes (id, name, formula) values(9, '30 Days', '30');
insert into timeframes (id, name, formula) values(10, '60 Days', '60');
insert into timeframes (id, name, formula) values(11, '90 Days', '90');

INSERT INTO base_reminders_timeframes (timeframe_id, base_reminder_id) VALUES
  (3, 1),
  (3, 2),
  (3, 3),
  (3, 4),
...
INSERT INTO content_items (name, content) VALUES
  ('privacy', '<h2>Privacy Policy</h2><p>Privacy policy goes here</h2>'),
  ('faqs', '<h2>Faqs</h2><p>FAQs go here</h2>'),
  ('contact', '<p>Got feedback for us? Email us at <a href="mailto:comms@codeforphilly.flowdock.com">comms@codeforphilly.flowdock.com</a></p><p>Wanna keep in touch? Follow us on Twitter.</p>'),
  ('disclaimer', '<h2>Disclaimer</h2><p>Disclaimer goes here</h2>'),
  ('disclaimer', '<h2>Disclaimer</h2><p>Disclaimer goes here</h2>'),
  ('faq-app-submission-date', '<p><strong>Question Goes Here</strong></p><p>Answer Goes Here</h2>'),
  ('faq-app-find', '<p><strong>Question Goes Here</strong></p><p>Answer Goes Here</h2>'),
  ('faq-regular-admissions', '<p><strong>Question Goes Here</strong></p><p>Answer Goes Here</h2>'),
  ('faq-rolling-admissions', '<p><strong>Question Goes Here</strong></p><p>Answer Goes Here</h2>'),
  ('faq-early-action', '<p><strong>Question Goes Here</strong></p><p>Answer Goes Here</h2>'),
