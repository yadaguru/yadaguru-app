...
insert into categories (name) values('Absolute Deadline');
insert into categories (name) values('Application');
insert into categories (name) values('Essay Writing');
insert into categories (name) values('Financial Aid');
insert into categories (name) values('General Reminder');
insert into categories (name) values('Portfolio Prep');
insert into categories (name) values('Recommendations');
insert into categories (name) values('Testing Registration');

INSERT INTO tests (type, message, detail) VALUES
  ('ACT', '<p>Go to <a href=\"http://actstudent.org\" target=\"\">actstudent.org </a>to register for your ACT test  Remember to include the schools you are applying to as a recipient of your test scores.</p>','If you''re planning on taking the ACT Test on %TESTDATE%, you must register by %REGDATE%.'),
  ('SAT', '<p>Go to the College Board site and register to take the SAT.  Go to <a href=\"https://sat.collegeboard.org/register\" target=\"\">https://sat.collegeboard.org/register</a>.  Remember to include the schools you are applying to as a recipient of your test scores.</p>', 'If you''re planning on taking the SAT Test on %TESTDATE%, you must register by %REGDATE%');
...
INSERT INTO base_reminders (name, message, category_id, detail) VALUES
...
insert into timeframes (name, formula) values('January 1', 'jan1');
insert into timeframes (name, formula) values('May 1', 'may1');
insert into timeframes (name, formula) values('Immediately', 'now');
insert into timeframes (name, formula) values('Due Date', '0');
insert into timeframes (name, formula) values('7 Days', '7');
insert into timeframes (name, formula) values('12 Days', '12');
insert into timeframes (name, formula) values('14 Days', '14');
insert into timeframes (name, formula) values('21 Days', '21');
insert into timeframes (name, formula) values('30 Days', '30');
insert into timeframes (name, formula) values( '60 Days', '60');
insert into timeframes (name, formula) values( '90 Days', '90');
