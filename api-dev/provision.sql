...
CREATE TABLE IF NOT EXISTS users (
  uuid          CHAR(35) PRIMARY KEY NOT NULL,
  phone_number  CHAR(10)             NOT NULL,
  personal_code CHAR(6)              NULL,
  sponsor_code  TEXT                 NULL
);

INSERT INTO reminders (user_uuid, timeframe, name, message, detail) VALUES

  ('temp', 'To do Immediately',
=======
