(function() {
  ...
  angular.module('yadaApp.services.testData', [])
    .factory('TestData', function() {
      ...
      reminders.push(new Reminder(17,'SATRegistrationDate','SAT Registration Date','Register for the SAT by %DATE%','The SAT can cause a lot of stress. Minimize your stress levels by taking the SAT early. That way if you need to take it again, you\'ll have time.',0));
      reminders.push(new Reminder(18,'LatestSAT','Latest SAT Registration Date','You should register for the SAT at the latest, by %DATE%','The schools need time to receive your SAT scores. If you register any later than %LatestSAT% there\'s a large chance that your schools won\'t get your scores by the submission date',0));
      reminders.push(new Reminder(19,'ACTRegistration','ACT Registration Date','Register for the ACT by %DATE%','The ACT can cause a lot of stress. Minimize your stress levels by taking the ACTsearly. That way if you need to take it again, you\'ll have time.',0));
